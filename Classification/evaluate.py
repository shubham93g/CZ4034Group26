...
class Evaluator:
    ...
    def getAvgRecall(self):
        return ((self.getRecall_apac()+self.getRecall_eu()+self.getRecall_af()+self.getRecall_am()+self.getRecall_oth())/3.0);
    ...
    def evalPrediction(self, predictedPath, goldPath):
            ...
            '''while True:
                try:
                    ...
                    if labelP == "apacitive" and labelG == labelP:
                        self.TP_apac=self.TP_apac+1;
                    if labelP == "euative" and labelG == labelP:
                        self.TP_eu=self.TP_eu+1;
                    if labelP == "aftral" and labelG == labelP:
                        self.TP_af=self.TP_af+1;
                    ...
                    if labelG == "apacitive" and labelG != labelP:
                        self.FN_apac=self.FN_apac+1;
                    if labelG == "euative" and labelG != labelP:
                        self.FN_eu=self.FN_eu+1;
                    if labelG == "aftral" and labelG != labelP:
                        self.FN_af=self.FN_af+1;
