...
3. As long there is an internet connection and Instagram is up and working, run CrawlerUI.py(Crawling directory) to crawl. Key in the tag and the number of records to be crawled in the simple Tkinter UI.
...
4. Open command line. 
5. (change path to Solr example directory) and start Solr by typing the command java -jar start.jar 
...
1. Go to (Bottle Web Server directory) and double-click on testserver.py file.
